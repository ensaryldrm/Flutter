...
class _ToggleButtonKullanimiState extends State<ToggleButtonKullanimi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Toggle Button Kullanımı"),
        ...
        child: Column(
          ...
          children: [
            ToggleButtons(
              ...
              color: Colors.red.shade400, // AKTİF OLMAYAN DÜĞME RENGİ
              selectedColor: Colors.cyan.shade900, // AKTİF OLAN DÜĞME RENGİ
              fillColor: Colors.blueGrey.shade200, // SEÇİLENİN ARKA PLAN RENGİ
